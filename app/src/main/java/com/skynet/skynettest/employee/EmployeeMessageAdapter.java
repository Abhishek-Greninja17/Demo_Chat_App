...
public class EmployeeMessageAdapter extends RecyclerView.Adapter<EmployeeMessageAdapter.MessageViewHolder>{
    ...
    public EmployeeMessageAdapter(List<MessageModel> msgList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        if (msgList.get(position).getType().equals("text")){    // text
            ...
            if (msgList.get(position).getFrom().equals(uid)) {
                ...
                holder.sender_audio.setText(msgList.get(position).getMessage().substring(msgList.get(position).getMessage().length()-8));
                holder.sender_audio_time.setText(msgList.get(position).getTime());
            }
            else {
                holder.receiver_audio_layout.setVisibility(View.VISIBLE);
                holder.receiver_audio.setText(msgList.get(position).getMessage().substring(msgList.get(position).getMessage().length()-8));
